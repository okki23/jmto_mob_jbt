...
class M_manual_non_etoll extends Parent_Model { 
   

  var $nama_tabel = 'm_manual_non_etoll';
  var $daftar_field = array('id', 'blok_tower', 'lantai', 'no_manual_non_etoll', 'luas', 'tipe', 'foto', 'harga', 'user_insert', 'date_insert', 'user_update', 'date_update');
  var $primary_key = 'id';
  ...
  public function fetch_manual_non_etoll(){   
           ...
           {  
			    ...
			    $sub_array[] = $row->no_manual_non_etoll;   
                $sub_array[] = $row->tipe;  
