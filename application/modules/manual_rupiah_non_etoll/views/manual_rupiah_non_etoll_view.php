            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Upload Manual Rupiah Non E-Toll
                            </h2>
                           ...
                           <div style="margin-left: 10px;">
                             <form method="post" name="frmGroupUser" id="frmGroupUser" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?php echo base_url('assets/excel_template/template_sample_form_upload_manual_rupiah_non_etoll.xls');?>" class="btn btn-success btn-sm">[Download Template]</a>
   ...
   <script type="text/javascript">
     $("#frmGroupUser").on("submit", function(event){
            ...
            var formData = new FormData(this);
             ...
             $.ajax({
                url : "<?php echo base_url('manual_rupiah_non_etoll/pro_upload'); ?>", 
                type : "post",
                data : formData,
                cache: false,
                contentType: false,
