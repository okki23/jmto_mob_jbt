...
class M_manual_etoll extends Parent_Model { 
   

  var $nama_tabel = 'm_manual_etoll';
  var $daftar_field = array('id', 'blok_tower', 'lantai', 'no_manual_etoll', 'luas', 'tipe', 'foto', 'harga', 'user_insert', 'date_insert', 'user_update', 'date_update');
  var $primary_key = 'id';
